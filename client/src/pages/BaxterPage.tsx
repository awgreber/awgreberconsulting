    ...
    <>
      <style>
        {`
          ...
          @keyframes baxter-hud-scan {
            0% { top: 0; }
            100% { top: calc(100% - 3px); }
          }
          @keyframes baxter-hud-online-dot {
          ...
          @keyframes baxter-hud-bar-revenue {
            0%, 100% { width: 68%; }
            50% { width: 92%; }
          }
          @keyframes baxter-hud-bar-eff {
            0%, 100% { width: 55%; }
            50% { width: 84%; }
          }
          @keyframes baxter-hud-bar-ins {
            0%, 100% { width: 72%; }
            50% { width: 96%; }
          }
          .baxter-hud-glow-ring {
            animation: baxter-hud-glow 2s ease-in-out infinite;
            border-radius: 0.625rem;
          }
          .baxter-hud-scan-line {
            position: absolute;
            left: 0;
            right: 0;
            height: 3px;
            ...
            animation: baxter-hud-scan 3s linear infinite;
            pointer-events: none;
          }
          .baxter-hud-bracket {
            position: absolute;
          ...
          .baxter-hud-bracket-tl {
            top: 10px;
            left: 10px;
            border-width: 2px 0 0 2px;
          }
          .baxter-hud-bracket-tr {
            top: 10px;
            right: 10px;
            border-width: 2px 2px 0 0;
          }
          .baxter-hud-bracket-bl {
            bottom: 36px;
            left: 10px;
            border-width: 0 0 2px 2px;
          }
          .baxter-hud-bracket-br {
            bottom: 36px;
            right: 10px;
            border-width: 0 2px 2px 0;
          }
          .baxter-hud-bar-fill-rev,
          .baxter-hud-bar-fill-eff,
          .baxter-hud-bar-fill-ins {
            display: block;
            height: 100%;
            max-width: 100%;
          }
          .baxter-hud-bar-fill-rev {
            animation: baxter-hud-bar-revenue 2.4s ease-in-out infinite;
          }
          .baxter-hud-bar-fill-eff {
            animation: baxter-hud-bar-eff 2.8s ease-in-out infinite;
          }
          .baxter-hud-bar-fill-ins {
            animation: baxter-hud-bar-ins 2.2s ease-in-out infinite;
          }
          .baxter-hud-online-dot {
            animation: baxter-hud-online-dot 1.8s ease-in-out infinite;
          }
        `}
      </style>
      <div className="mx-auto w-full max-w-[min(100%,320px)]">
        <div className="baxter-hud-glow-ring bg-[#0f1117] p-[2px]">
          <div className="relative overflow-hidden rounded-[10px] bg-[#0f1117]">
            <div className="relative w-full cursor-pointer" onClick={handleVideoClick}>
              <video
                ref={videoRef}
                src={encodeURI('/Baxter Agent.mp4')}
                ...
                aria-label="Baxter agent preview"
              />
              {showPlayOverlay ? (
                <div
            ...
            <div
              ...
              aria-hidden
            >
              <div className="baxter-hud-scan-line" />
            </div>

            <div className="baxter-hud-bracket baxter-hud-bracket-tl" aria-hidden />
            <div className="baxter-hud-bracket baxter-hud-bracket-tr" aria-hidden />
            <div className="baxter-hud-bracket baxter-hud-bracket-bl" aria-hidden />
            <div className="baxter-hud-bracket baxter-hud-bracket-br" aria-hidden />
            ...
            <div
              ...
              role="status"
            >
              <span className="baxter-hud-online-dot inline-block h-2 w-2 rounded-full bg-[#10b981]" />
              ONLINE
            </div>
            ...
            <div className="absolute bottom-11 left-1.5 z-10 max-w-[46%] rounded border border-[rgba(59,130,246,0.35)] bg-[rgba(15,17,23,0.88)] px-2 py-1.5 text-[9px] leading-tight sm:bottom-14 sm:left-2.5 sm:max-w-[140px] sm:px-2.5 sm:py-2 sm:text-[10px]">
              ...
              <div className="text-[#f8fafc]">K9-OPS-03</div>
              <div className="mt-1.5 font-semibold uppercase tracking-wide text-[#94a3b8]">
                MODE
              </div>
              <div className="text-[#f8fafc]">AUTONOMOUS</div>
            </div>
            ...
            <div className="absolute bottom-11 right-1.5 z-10 max-w-[46%] rounded border border-[rgba(59,130,246,0.35)] bg-[rgba(15,17,23,0.88)] px-2 py-1.5 text-[9px] leading-tight sm:bottom-14 sm:right-2.5 sm:max-w-[140px] sm:px-2.5 sm:py-2 sm:text-[10px]">
              <div className="mb-1.5">
                ...
                <div className="mt-0.5 h-1.5 w-full overflow-hidden rounded-full bg-[rgba(148,163,184,0.25)]">
                  <div className="baxter-hud-bar-fill-rev h-full rounded-full bg-[#3b82f6]" />
                </div>
              </div>
              <div className="mb-1.5">
                <div className="font-semibold uppercase tracking-wide text-[#94a3b8]">
                ...
                <div className="mt-0.5 h-1.5 w-full overflow-hidden rounded-full bg-[rgba(148,163,184,0.25)]">
                  <div className="baxter-hud-bar-fill-eff h-full rounded-full bg-[#f59e0b]" />
                </div>
              </div>
              <div>
                <div className="font-semibold uppercase tracking-wide text-[#94a3b8]">
                ...
                <div className="mt-0.5 h-1.5 w-full overflow-hidden rounded-full bg-[rgba(148,163,184,0.25)]">
                  <div className="baxter-hud-bar-fill-ins h-full rounded-full bg-[#10b981]" />
                </div>
              </div>
            </div>
            ...
            >
              Baxter · AI Unit 03 · AWG Consulting
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6">
          <motion.div {...fadeUp}>
            ...
            <h1 className="mt-3 text-4xl font-bold tracking-tight md:text-5xl lg:text-6xl">
              Baxter. Operational rebuild
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-[#94A3B8] md:text-xl">
              Fully agentic, end to end. What we build when AI becomes core to how the operation
              runs, not a side project.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-6 sm:px-6">
        <motion.div {...fadeUp}>
          ...
          <blockquote className="mt-4 max-w-3xl text-2xl font-medium leading-snug text-[#F8FAFC] md:text-3xl">
            Four or more implementations. A full operational stack.
          </blockquote>
        </motion.div>
      </section>
